...
def build_general_semantic_pack_v0() -> dict[str, Any]:
    ...
    concepts = [
        ...
        _concept("atanor", "ATANOR", ["아타노르"], "ATANOR is a local-first knowledge engine that separates semantic reasoning from surface expression.", [("uses", "semantic_graph", 0.82), ("uses", "surface_graph", 0.82), ("requires", "privacy", 0.78)], ko="ATANOR"),
