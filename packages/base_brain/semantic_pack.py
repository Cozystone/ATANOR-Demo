...
def build_general_semantic_pack_v0() -> dict[str, Any]:
    ...
    concepts = [
        _concept(
            ...
            "Kubernetes is a system for deploying, scaling, and operating containers across machines.",
            [("is_a", "container_orchestration_system", 0.94), ("manages", "container", 0.92), ("enables", "software_deployment", 0.86)],
            ko="쿠버네티스",
        ),
        _concept("container_orchestration_system", "container orchestration system", ["컨테이너 오케스트레이션"], "A system that schedules and manages containerized workloads.", [("used_for", "software_deployment", 0.86)], ko="컨테이너 오케스트레이션 시스템"),
        ...
        _concept("ai_training", "AI model training", ["모델 학습", "training"], "Training adjusts model parameters from data so future inference can produce useful outputs.", [("contrasts_with", "ai_inference", 0.9)], ko="AI 모델 학습"),
        ...
        _concept("voltage", "voltage", ["전압"], "Voltage is electric potential difference, often described as the pressure that pushes charge.", [("contrasts_with", "current", 0.8)], ko="전압"),
        _concept("current", "current", ["전류"], "Current is the flow rate of electric charge through a circuit.", [("depends_on", "voltage", 0.65)], ko="전류"),
        _concept("quantum_computer", "quantum computer", ["양자컴퓨터"], "A quantum computer uses quantum states for certain kinds of computation, but it is not a magic universal speedup.", [("contrasts_with", "classical_computer", 0.74)], ko="양자컴퓨터"),
        _concept("graphrag", "GraphRAG", ["그래프 RAG", "graph retrieval augmented generation"], "GraphRAG retrieves facts through graph relationships and evidence paths before composing an answer.", [("requires", "semantic_graph", 0.9), ("used_for", "hallucination_reduction", 0.8)], ko="GraphRAG"),
        ...
        _concept("semantic_graph", "semantic graph", ["의미 그래프", "knowledge graph"], "A semantic graph stores meanings as nodes and relationships rather than as only raw text.", [("contrasts_with", "surface_graph", 0.82)], ko="의미 그래프"),
        ...
        _concept("web_search", "web search", ["웹 검색"], "Web search finds public information from the internet, but it is distinct from local offline graph reasoning.", [("used_for", "needs_external_context", 0.68)], ko="웹 검색"),
        _concept("korean_language", "Korean language", ["한국어"], "Korean uses particles and sentence endings that must be handled natively for natural answers.", [("contrasts_with", "english_language", 0.7)], ko="한국어"),
